...
#+CAPTION: Clock summary at [2018-11-30 Fr 21:54]
| Headline     | Time       |
|--------------+------------|
| *Total time* | *1d 17:46* |
|--------------+------------|
...
TODO clean view of empty lists and redundant entries
** [2018-11-29 Do]
...
TODO show absolut and relativ percent in view plot after category
TODO inverse actions and cards in order to show TOP->BOTTOM and raise/bet -> fold/call
TODO check if range files are equal -> probably sign of wrong gui input
** [2018-11-30 Fr]

TODO when having AI as only option after bet it asumes fold call AI ranges even when there is no call because 
of very low spr

TODO BUG on view board KdJh5h4c (striaght draws)
TODO set > straight on flush boards
TODO gui -> check oop (no donk/bet) not working (thinks check and bet?!)
