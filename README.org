...
- on AQ7AA it has AK AQ AJ in high card range and not KQ KJ KT [2019-01-05 Sa]
- on AsQd7dAc trips hands with kicker are in wrong order KA, JA, TA instead of AK AJ AT ( ok probably intended and only 
weird on A high baords) [2019-01-05 Sa]
- straight flushes are not recognised! [2019-01-11 Fr]
- 2 trips board low trips
- middle pairs on paired board (overall more middle / low pairs?)
...
- Legende durchsichtig [2019-02-04 Mo]
